fid=fopen('C:\Users\Public\MATLAB\supermarket\market.txt','r');
if fid==-1
    mkdir('C:\Users\Public\MATLAB\supermarket');
    fname='C:\Users\Public\MATLAB\supermarket\products.txt';
    fid1=fopen(fname,'w');
    ...
    fclose(fid1);
    fid=fopen('C:\Users\Public\MATLAB\supermarket\market.txt','w');
    fprintf(fid,'This program is made by:\nAnmol\tGayathari\tAniruddh');
    fclose(fid);
end;
c='y';
item=0;
...
switch ch
    case '1'
        sum=0;
        cnt='y';
        fid1=fopen('C:\Users\Public\MATLAB\supermarket\current.txt','w');
        fclose(fid1);
        while cnt=='y' || cnt=='Y'
          clc;
          fid=fopen('C:\Users\Public\MATLAB\supermarket\products.txt','r');
          fname='C:\Users\Public\MATLAB\supermarket\products.txt';
          fid1=fopen('C:\Users\Public\MATLAB\supermarket\current.txt','a');
          fid2=fopen('C:\Users\Public\MATLAB\supermarket\price.txt','r');
          fprintf('\nNet Amount: %d',sum);
        ...
        clc;
        fprintf('\n\t\t\t\t\t\t\tSRM Supermarket');
        fprintf('\n\t\t\t\t\tContact Number: 044-2244-6688')
        fprintf('\n________________________________________________________________');
        fprintf('\n\t\tITEMS\t\t\t\t\t\t\t\t\t\tPRICE');
        fid=fopen('C:\Users\Public\MATLAB\supermarket\current.txt','r');
        for i=0:1:item
              pname=fgetl(fid);
              fprintf('\n');
              fprintf('%s',pname);
        ...
        net=sum-dis;
        fprintf('\nDiscount: Rs. %d/-\n',floor(dis));
        fprintf(2,'\n\n\n\n\nNet Amount Payable: Rs. %d/-',floor(net));
